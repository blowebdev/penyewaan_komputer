        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <H5>Masukan kode transaksi disini</H5>
                            <form action="" method="POST">
                                <label>Input Pencarian</label>
                                <input type="text" name="kode_transaksi" value="<?php echo $_REQUEST['kode_transaksi']; ?>" placeholder="Masukan kode transaksi disini" class="form-control" required>
                                <br>
                                <button class="btn btn-success" type="submit" name="cari"><i class="fa fa-search"></i> Cari</button>
                            </form>
                        </div>
                    </div>
                </div>
                <?php if(isset($_REQUEST['cari'])) :  
                    $_REQUEST['id'] = $_REQUEST['kode_transaksi'];
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <?php 
                                $data = mysqli_query($conn,"SELECT * FROM master_transaksi WHERE kode_transaksi='".$_REQUEST['kode_transaksi']."'");
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-centered border mb-0">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <th scope="row" width="1%" nowrap="">Status :</th>
                                                                                        <td><?php echo status($detail_transaksi['status']); ?></td>
                                                                                    </tr>
                                                                                    <tr>
                                ...
                                <?php else : ?>
                                    <div class="alert alert-danger">Mohon maaf data tidak ditemukan</div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
